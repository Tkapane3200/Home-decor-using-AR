...
//        return inflater.inflate(R.layout.fragment_app_details, container, false);
        ...
        isUserLoggedIn = view.findViewById(R.id.isUserLoggedInId);
        serverUrl = view.findViewById(R.id.serverUrlId);
        ...
        if (session.getLoggedIn()) {
            ...
            isUserLoggedIn.setText("User is logged in with user id: " + getUserId);
        } else {
            isUserLoggedIn.setText("User is not logged in");
        }

        serverUrl.setText("Server URL: " + Constant.BASE_URL);
